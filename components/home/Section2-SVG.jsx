...
function Section2() {
  return (
    <div className="overflow-x-clip relative w-screen -mt-52 bg-neutral-50 flex text-sm font-medium text-neutral-600 sm:text-base text-clip  sm:text-center tracking-wide h-screen flex-col items-center justify-center shadow-md shadow-black/30 z-0">
